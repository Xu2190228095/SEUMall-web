  ...
  <div id="search-page">
    <el-header class="header">
      ...
      <el-input
        ...
        @input="handleSearch"
      />
      <el-button type="primary" icon="el-icon-search" style="height: 100%; padding: 0 10px;" @click="searchProducts">
        搜索
      </el-button>
    </el-header>
  ...
  setup() {
    ...
    const searchProducts = () => {
      if (searchQuery.value.trim()) {
        router.push({ name: 'SearchProduct', query: { q: searchQuery.value } });  // 更新路由
