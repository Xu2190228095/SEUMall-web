...
<!--&lt;!&ndash;          <template slot-scope="scope">{{scope.pid}}</template>&ndash;&gt;-->
<!--        </el-table-column>-->
...
<!--      &lt;!&ndash;    <el-table-column prop="deptno" label="deptno" width="180"></el-table-column>&ndash;&gt;-->
<!--      &lt;!&ndash;    <el-table-column prop="dname" label="dname" width="180"></el-table-column>&ndash;&gt;-->
<!--      &lt;!&ndash;    <el-table-column prop="loc" label="loc"></el-table-column>&ndash;&gt;-->
